...
function MatHorizontalStepper_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r32._getFocusIndex() === i_r35 ? 0 : 0 - 1)("id", ctx_r32._getStepLabelId(i_r35))("index", i_r35)("state", ctx_r32._getIndicatorType(i_r35, step_r34.state))("label", step_r34.stepLabel || step_r34.label)("selected", ctx_r32.selectedIndex === i_r35)("active", step_r34.completed || ctx_r32.selectedIndex === i_r35 || !ctx_r32.linear)("optional", step_r34.optional)("errorMessage", step_r34.errorMessage)("iconOverrides", ctx_r32._iconOverrides);
...
function MatHorizontalStepper_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("aria-labelledby", ctx_r33._getStepLabelId(i_r42))("aria-expanded", ctx_r33.selectedIndex === i_r42);
    ɵngcc0.ɵɵadvance(1);
...
function MatVerticalStepper_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("aria-labelledby", ctx_r45._getStepLabelId(i_r47))("aria-expanded", ctx_r45.selectedIndex === i_r47);
    ɵngcc0.ɵɵadvance(2);
